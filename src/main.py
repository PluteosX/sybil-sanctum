...
from utils.message_utils import send_last_hour_coins_message
...
def main():
    ...
    parser.add_argument("--generate", choices=[CHAINS_INFO, TOP_10_WEEK_COINS, TODAY_COINS, LAST_HOUR_COINS],
    ...
    elif args.generate == LAST_HOUR_COINS:
        new_cryptocurrencies_list = get_new_cryptocurrencies_list()
        last_hour_coins = get_added_coins(new_cryptocurrencies_list, LAST_HOUR_COINS)
        send_last_hour_coins_message(last_hour_coins)
